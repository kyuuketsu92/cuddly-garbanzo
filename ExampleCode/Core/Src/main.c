...
/* Private macro -------------------------------------------------------------*/
/* USER CODE BEGIN PM */
#define TASK_SCREEN_INIT 0x00000001
#define TASKS_ALL TASK_SCREEN_INIT
/* USER CODE END PM */
...
/* Definitions for TasksInit */
osEventFlagsId_t TasksInitHandle;
const osEventFlagsAttr_t TasksInit_attributes = {
  .name = "TasksInit"
};
/* USER CODE BEGIN PV */
